...
<head>
    ...
    <title>Ubah Data Pegawai - Rikkes Berkala</title>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="<?= base_url('employee/p_edit/' . $employee->id)?>" method="post" role="form">

                            <div class="form-group">
                                <label>NRP</label>
                                <input class="form-control" name="nrp" type="text" value="<?= ((NULL != set_value('nrp')) ? set_value('nrp'):$employee->nrp) ?>" placeholder="NRP">
                            </div>

                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" name="nama" class="form-control" value="<?php echo ((NULL != set_value('nama')) ? set_value('nama'):$employee->nama);  ?>" placeholder="Nama">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="jabatan" class="form-control">
                                    ...
                                    <option value="<?= $jabatan->id; ?>" <?php if (NULL != set_value('jabatan')) { echo set_select('jabatan', $jabatan->id); } else { echo ($employee->jabatan_id == $jabatan->id ? 'selected': ''); } ?>><?= $jabatan->name; ?></option>                                    
                                    <?php endforeach;  ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="keterangan" class="form-control" rows="10" placeholder="Tambahkan keterangan"><?php echo ((NULL != set_value('keterangan')) ? set_value('keterangan') : $employee->keterangan); ?></textarea>
                            </div>
